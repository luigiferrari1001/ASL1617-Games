var frasig= "SORGENTE STREGONE MAGO LAGO LOGO ROGO RIGO NOTA CROMA AROMA AMARO DOLCE ACQUA RUBINETTO";
var introduzioni = "Partendo da SORGENTE devi arrivare a RUBINETTO, cambiando la sequenza delle parole sottoelencate. Nel percorso ogni parola deve essere collegata a quella che precede o segue con criteri diversi: aggiunta o scarto di una lettera, anagramma, associazione di idee.";

var frasi = "SORGENTE ACQUA AMARO AROMA CROMA DOLCE LAGO LOGO MAGO NOTA RIGO ROGO STREGONE RUBINETTO";

var immagini="Immagini/Blu.png";
...
function separa(){
	...
	s2 = "";
	s = '<div  class="draggablein" id="b'+0+'"> <p class="testo"  id="ti'+0+'">'+a[0]+'</p> </div>';
	s2 = s2 + s;
	...
	s = '<div  class="draggableout" id="b'+ultima+'"><p class="testo"  id="ti'+ultima+'">'+a[ultima]+'</p> </div>';
	s2 = s2 + s;
...
//var spazio = document.getElementById("ti"+ev).innerHTML;;
