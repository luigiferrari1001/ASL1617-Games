...
function tornaIndietro (el_id){
	...
	if (document.getElementById('356b').style.opacity=="0.5" || document.getElementById('356b').style.opacity=="0.6")
		return;
	if (diag == true)
		return;
	if (a > 0)
...
function changeColor (element_id){
	if (document.getElementById('29b').style.opacity!="0.5" && document.getElementById('29b').style.opacity!="0.6")
		return;
	if (u > 0)
		return;
	if (ind == false)
...
function controlloEst (element_id){
	...
	if (document.getElementById('29b').style.opacity=="0.5" || document.getElementById('29b').style.opacity=="0.6" && k==383)
		window.location.reload();
}


// Rende piu' trasparenti gli ultimi due bottoni su cui e' passato il mouse.
